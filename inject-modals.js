  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form id="contaFixaForm">
        ...
        <div class="form-row"><div class="form-group"><label for="contaFixaCategoria">Categoria *</label><select id="contaFixaCategoria" required><option value="">Selecione</option><option value="estrutura">Estrutura</option><option value="operacional">Operacional</option><option value="tributos">Tributos</option><option value="servicos">Servicos</option></select></div></div>
      </form>
    </div>
    <div class="modal-footer">
